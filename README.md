...
- 🛠️ Added `/catalog-stats.json` and dynamic counters on `/configure`
- 🧪 Added `npm run test:smoke` for manifest/catalog/meta route validation

### 🎯 Previous highlights (v13.0)
